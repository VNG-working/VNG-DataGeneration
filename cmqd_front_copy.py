...
class CMQD(OfficialID):
    def __init__(self, dst='data/cmqd/test/'):
        super().__init__(dst)
        # dst = 'data/test/'
        self.dst = dst
    ...
    def fakeMainInfo(self):
        ...
        r, g, b = self.stamp_sign_ink
        text = self.write(text, char_font=font, 
        ...
        text = self.write(text, char_font=self.Bold, ink=randink(True))
        self.get_field_coord(text, [text], ["pow"], self.Bold)
        ...
        text = self.write(text, self.italic)
        ...
        text = self.write(text, char_font=self.Bold_CVK, ink=randink(True))
        self.get_field_coord(text, [text], ["signer_position"], self.Bold_CVK)
